...
const Cards = ({currentValue , title , desc , icon , inLastWeek , inLastMonth}) => {
    return (
        <div className="col-12 col-md-6 col-lg-3 dashboard_card_parent">
            ...
            <div className="card text-dark bg-info mb-3 dashboard_card d-flex flex-row" >
                <div className="card-body py-1 row">
                    <small className="m-0 d-block text_truncate">  <b>{inLastWeek}</b>در هفته گذشته</small>
                    <small className="m-0 d-block text_truncate">  <b>{inLastMonth}</b>در ماه گذشته</small>
                </div>
            </div>
        </div>
    );
